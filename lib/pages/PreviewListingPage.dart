...
class PreviewListingPage extends StatefulWidget{
  @override
  _PreviewListingPage createState() => _PreviewListingPage();
}

class _PreviewListingPage extends State<PreviewListingPage>{
              ...
              child: Stack(
                children: <Widget>[
                  Carousel(
                    ...
                    dotIncreasedColor: AppTheme.colors.appPink,
                    ...
                    child: RaisedButton(
                      ...
                      child:
                          RichText(text : TextSpan(children: [
                            TextSpan(text: "LIST FOR ",style: TextStyle(fontSize: 15, fontWeight: FontWeight.normal, color: Colors.white)),
                            TextSpan(text: "\$20",style: TextStyle(fontSize: 15, fontWeight: FontWeight.w900, color: Colors.white)),
                            TextSpan(text: " PER MONTH",style: TextStyle(fontSize: 15, fontWeight: FontWeight.normal, color: Colors.white)),
                          ]),),
                      ),
                  ),
