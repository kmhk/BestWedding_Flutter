...
class SubscriberCalendar4Page extends StatefulWidget{

  _SubscriberCalendar4Page createState() => _SubscriberCalendar4Page();
}

class _SubscriberCalendar4Page extends State<SubscriberCalendar4Page>{
              ...
              child: Column(
                children:<Widget> [
                  ...
                  Container(
                   ...
                   /*child: Row(
                     children: <Widget>[
                       Radio(value: 1, groupValue: selectedRadio,activeColor: Colors.green, onChanged: (val){})
                       TextField(
                         decoration: InputDecoration(
                           contentPadding: EdgeInsets.symmetric(vertical: 1.0.h, horizontal: 5.0.w),
                           hintText: "Enter Post Code",
