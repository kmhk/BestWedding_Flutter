...
class AddYourCriteriaPage extends StatefulWidget{
  @override
  _AddYourCriteriaPage createState()=> _AddYourCriteriaPage();
}

class _AddYourCriteriaPage extends State<AddYourCriteriaPage>{
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Align(
                ...
                child: Container(
                  child: Text("Add your criteria",
                    style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20.0.sp, color: AppTheme.colors.appTextColor),
                  ),
                ),
              ),
            ),
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: RaisedButton(
                      onPressed: () {HelpersService.push(context, '/newListingUploadImage');},
